        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            ...
            {experiences.map((exp, index) => (
              <div key={index} className="relative mb-8 sm:mb-12 group/exp">
                {/* Timeline dot with glow */}
                <div className="absolute left-4 sm:left-6 md:left-1/2 transform md:-translate-x-1/2 w-3 h-3 sm:w-4 sm:h-4 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full border-4 border-gray-950 z-10 group-hover/exp:shadow-lg group-hover/exp:shadow-blue-500/50 transition-shadow duration-300"></div>
                
                <div className="ml-10 sm:ml-16 md:ml-0 bg-gray-900/80 backdrop-blur-sm border border-gray-800 rounded-xl p-4 sm:p-6 hover:border-gray-600 transition-all duration-300 group-hover/exp:shadow-xl group-hover/exp:shadow-blue-500/5">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-3 sm:mb-4">
                    <div className="flex items-center mb-2 sm:mb-0">
                      <div className="p-1.5 bg-blue-500/10 rounded-lg mr-3 group-hover/exp:bg-blue-500/20 transition-colors">
                  ...
                  <div className="flex flex-wrap gap-1.5 sm:gap-2">
                    {exp.techStack.map((tech) => (
                      <span
                        key={tech}
                        className="px-2.5 py-1 bg-gray-800 text-gray-300 rounded-lg text-xs font-medium hover:bg-gray-700 hover:text-white transition-colors cursor-default"
                      >
                        {tech}
                      </span>
                    ))}
