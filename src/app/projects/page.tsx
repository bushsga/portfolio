...
export default function ProjectsPage() {
  ...
  A comprehensive collection of 7 web and mobile development projects.
  From React applications to full‑stack e‑commerce solutions.
</p>
        </div>
...
<div className="grid grid-cols-2 md:grid-cols-4 gap-6">
  <div className="text-center">
    <div className="text-2xl sm:text-3xl font-bold text-blue-400 mb-2">7</div>
  ...
  <div className="text-center">
    <div className="text-2xl sm:text-3xl font-bold text-yellow-400 mb-2">5</div>
